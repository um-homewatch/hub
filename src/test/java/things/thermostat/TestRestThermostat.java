...
public class TestRestThermostat {
  ...
  public static void setup() throws UnknownHostException {
    thermostatService = new RestThermostatService(InetAddress.getLocalHost(), PORT);
  ...
  public void testBadPing() throws UnknownHostException {
    ThingService<Thermostat> badThermostatService = new RestThermostatService(InetAddress.getLocalHost());
