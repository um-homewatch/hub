...
public class TestRestLock {
  ...
  public static void setup() throws UnknownHostException {
    lockService = new RestLockService(InetAddress.getLocalHost().getHostName(), PORT);
  }
  ...
  public void testBadPing() throws UnknownHostException {
    ThingService<Lock> badLockService = new RestLockService(InetAddress.getLocalHost().getHostName());
